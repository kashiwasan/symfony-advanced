<?php slot('pager') ?>
<?php sa_include_pager_navigation($options['pager'], $options['link_to_page'], array('use_current_query_string' => true)); ?>
<?php end_slot(); ?>
...
<?php echo link_to(sa_image_tag_sf_image($result->getImageFilename(), array('size' => '76x76')), sprintf($options['link_to_detail'], $result->getId())); ?><br />
...
<tr>
<th><?php echo $caption ?></th><td><?php echo sa_truncate($item, 36, '', 3) ?></td>
</tr>
<?php endforeach; ?>
</tbody></table></div></div>
<?php endforeach; ?>
