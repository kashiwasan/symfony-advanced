<div class="row">
  <div class="gadget_header span12"><?php echo __('Add %my_friend%', array('%my_friend%' => $sa_term['my_friend']->pluralize())) ?></div>
</div>

<div class="row">
  <div class="span4"><?php echo link_to(sa_image_tag_sf_image($member->getImageFileName(), array('size' => '48x48')), '@member_profile?id='.$id) ?></div>
