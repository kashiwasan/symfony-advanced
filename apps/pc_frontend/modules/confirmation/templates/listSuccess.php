...
<?php echo link_to(sa_image_tag_sf_image($item['image']['url'], array('size' => '76x76')), $item['image']['link']); ?>
</td>
</tr>
...
<?php else: ?>
<?php sa_include_box('searchMemberResult', __('You don\'t have any pending requests'), array('title' => __($config[$category]))) ?>
<?php endif; ?>
