...
$(function(){
  $.getJSON( sfadvanced.apiBase + 'member/search.json?target=friend&target_id=<?php echo $member->getId() ?>&apiKey=' + sfadvanced.apiKey, function(json) {
  ...
  $('#memberFriendSearch').blur(function(){
    ...
    var requestData = { target: 'friend', target_id: <?php echo $member->getId(); ?>, keyword: keyword, apiKey: sfadvanced.apiKey };
