...
$(function(){
  $.getJSON( sfadvanced.apiBase + 'community/search.json?apiKey=' + sfadvanced.apiKey, function(json) {
  ...
  $('#joinCommunitySearch').blur(function(){
    ...
    var requestData = { keyword: keyword, apiKey: sfadvanced.apiKey };
    $.getJSON( sfadvanced.apiBase + 'community/search.json', requestData, function(json) {
      if (json.data.length > 0) {
