<?php sa_mobile_page_title($community->getName(), __('Edit %community% Photo')) ?>
<center>
<?php if ($community->getImageFileName()): ?>
<?php echo sa_image_tag_sf_image($community->getFile(), array('size' => '120x120', 'format' => 'jpg')) ?><br>
<?php echo sprintf('[%s | %s]',
  link_to(__('Expansion'), sf_image_path($community->getFile(), array('size' => saConfig::get('mobile_image_max_size'), 'format' => 'jpg'))),
...
<?php echo sa_mail_to('community_add_image', array('id' => $community->id), __('Send E-mail')) ?>
<?php else: ?>
