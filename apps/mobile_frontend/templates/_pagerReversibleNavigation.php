...
<?php echo sa_link_to_for_pager($options['prev_text'], $sf_data->getRaw('internalUri'), $pager->getOlderPage(), array_merge(array('accesskey' => 4), $options->getRaw('link_options'))) ?>
<?php endif; ?>
...
<?php echo sa_link_to_for_pager($options['next_text'], $sf_data->getRaw('internalUri'), $pager->getNewerPage(), array_merge(array('accesskey' => 6), $options->getRaw('link_options'))) ?>
<?php endif; ?>
</center>
<?php endif; ?>
