...
<tr><td bgcolor="<?php echo $sa_color["core_color_11"] ?>"><font color="<?php echo $sa_color["core_color_18"] ?>"><?php echo $form->getAuthAdapter()->getAuthConfig('auth_mode_caption') ? __($form->getAuthAdapter()->getAuthConfig('auth_mode_caption')) : $form->getAuthMode() ?></font></td></tr>

<tr><td bgcolor="<?php echo $sa_color["core_color_4"] ?>">
...
<?php if ($form->getAuthAdapter()->getAuthConfig('invite_mode') == 2 && saToolkit::isEnabledRegistration('mobile') && $form->getAuthAdapter()->getAuthConfig('self_invite_action')): ?>
