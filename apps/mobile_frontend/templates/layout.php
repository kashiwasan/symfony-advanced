...
<?php include_title() ?>
<?php if ($sf_request->getMobile()->isSoftBank() && $sa_config['font_size']): ?>
<style type="text/css">
*{font-size:small;}
</style>
<?php elseif ($sf_request->getMobile()->isEZWeb() && $sa_config['font_size']): ?>
<style type="text/css">
*{font-size:xx-small;}
</style>
<?php endif; ?>
<?php echo $sa_config->get('mobile_html_head') ?>
</head>
<body
<?php if (!($sf_request->getMobile()->isDocomo() && '#000000' === $sa_color['core_color_14'])): ?>
 text="<?php echo $sa_color['core_color_14'] ?>"
<?php endif; ?>
 bgcolor="<?php echo $sa_color['core_color_1'] ?>"
 link="<?php echo $sa_color['core_color_15'] ?>"
<?php if ($sf_request->getMobile()->isDocomo()): ?>
 alink="<?php echo $sa_color['core_color_23'] ?>"
<?php endif; ?>
 vlink="<?php echo $sa_color['core_color_17'] ?>"
>
<?php echo $sa_config->get('mobile_header') ?>
...
<font color="<?php echo $sa_color["core_color_22"] ?>"><?php echo __($sf_user->getFlash('error')) ?></font><br>
<?php endif; ?>
<?php if ($sf_user->hasFlash('notice')): ?>
<font color="<?php echo $sa_color["core_color_22"] ?>"><?php echo __($sf_user->getFlash('notice')) ?></font><br>
<?php endif; ?>
...
<?php if (has_slot('sa_mobile_footer_menu')): ?>
<hr color="<?php echo $sa_color["core_color_11"] ?>">
<?php include_slot('sa_mobile_footer_menu'); ?>
<?php endif; ?>

<?php echo sa_within_page_link(''); ?>
<a name="bottom"></a>
...
<?php endif; ?>
<?php endif; ?>
<?php echo $sa_config->get('mobile_footer') ?>
</body>
</html>
