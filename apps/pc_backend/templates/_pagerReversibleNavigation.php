...
<?php echo sa_link_to_for_pager($options['prev_text'], $sf_data->getRaw('internalUri'), $pager->getOlderPage(), $options->getRaw('link_options')) ?>&nbsp;
<?php endif; ?>
<?php if ($options['is_total']): ?>
<?php sa_include_pager_total($pager) ?>
<?php endif; ?>
<?php if ($pager->hasNewerPage()): ?>
&nbsp;<?php echo sa_link_to_for_pager($options['next_text'], $sf_data->getRaw('internalUri'), $pager->getNewerPage(), $options->getRaw('link_options')) ?>
<?php endif; ?>
<?php endif; ?>
