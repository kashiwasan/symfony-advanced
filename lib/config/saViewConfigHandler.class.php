...
/**
 * saViewConfigHandler allows you to configure views for SfAdvanced.
 *
 * @package    SfAdvanced
 * @subpackage config
 * @author     Kousuke Ebihara <ebihara@php.net>
 */
class saViewConfigHandler extends sfViewConfigHandler
{
  public function execute($configFiles)
  {
    ...
    $result .= sprintf("// auto-generated by saViewConfigHandler\n".
                      "// date: %s\n%s\n",
