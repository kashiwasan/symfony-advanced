...
$memberProfile1 = $table->retrieveByMemberIdAndProfileName(1, 'sa_preset_sex');
$memberProfile2 = $table->retrieveByMemberIdAndProfileName(1, 'sa_preset_birthday');
$memberProfile3 = $table->retrieveByMemberIdAndProfileName(1, 'sa_preset_region');
$memberProfile4 = $table->retrieveByMemberIdAndProfileName(1, 'sa_preset_self_introduction');
...
$memberProfile9 = $table->retrieveByMemberIdAndProfileName(2, 'sa_preset_birthday');
